	...
	<div id="frame">
		<div class="content">
			<div class="contact-profile">
				<img src="http://icons.iconarchive.com/icons/killaaaron/adobe-cc-circles/1024/Adobe-Ai-icon.png" alt="" />
				<p>AI</p>
			...
			<div class="messages">
				<ul>
					...
					<li class="replies"><img
						src="http://icons.iconarchive.com/icons/killaaaron/adobe-cc-circles/1024/Adobe-Ai-icon.png" alt="" />
			...
			<div class="message-input">
				<div class="wrap">
					<input id="test" type="text" placeholder="Write your message..." />
					<i class="fa fa-paperclip attachment" aria-hidden="true"></i>
				<button id="1212" type="button" onclick="addchat()">
